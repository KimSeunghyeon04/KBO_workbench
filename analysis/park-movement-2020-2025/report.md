# 2020~2025 KBO 투구 무브먼트의 구장 편향 분석
...
| 시즌 | 봉인 경기 | 실제 투구 | 유효 무브먼트 | 유효 비율 |
| --- | --- | --- | --- | --- |
| 2020 | 763 | 233,557 | 226,482 | 97.0% |
| 2021 | 767 | 235,129 | 222,568 | 94.7% |
| 2022 | 802 | 240,400 | 220,993 | 91.9% |
| 2023 | 798 | 242,972 | 223,216 | 91.9% |
| 2024 | 784 | 241,646 | 236,904 | 98.0% |
| 2025 | 779 | 235,054 | 231,767 | 98.6% |
...
| 구장 | 경기 | 투수 | 좌우 편향 cm (95% CI) | 상하 편향 cm (95% CI) |
| --- | --- | --- | --- | --- |
| 고척 | 75 | 172 | +5.15 [+4.76, +5.53] | +8.72 [+8.00, +9.43] |
| 광주 | 73 | 175 | +2.20 [+1.60, +2.80] | +0.45 [-0.20, +1.10] |
| 대구 | 80 | 183 | -4.06 [-4.52, -3.60] | -1.78 [-2.24, -1.32] |
| 대전신 | 81 | 180 | +1.37 [+0.99, +1.74] | -2.07 [-2.71, -1.43] |
| 문학 | 81 | 174 | -11.11 [-11.82, -10.41] | +3.59 [+3.05, +4.13] |
| 사직 | 80 | 179 | -1.08 [-1.46, -0.69] | -9.16 [-9.99, -8.33] |
| 수원 | 78 | 179 | +15.45 [+14.61, +16.30] | +6.06 [+5.36, +6.75] |
| 잠실 | 149 | 206 | -2.47 [-2.89, -2.06] | -2.49 [-3.01, -1.97] |
| 창원 | 69 | 164 | -1.98 [-2.54, -1.42] | -0.41 [-0.85, +0.03] |
...
| 시즌 | 검증 셀 수 | 좌우 RMSE cm | 상하 RMSE cm |
| --- | --- | --- | --- |
| 2020 | 9,210 | 7.30 → 3.98 (45.4% 감소) | 4.42 → 2.86 (35.3% 감소) |
| 2021 | 8,924 | 7.22 → 3.58 (50.4% 감소) | 4.20 → 2.86 (31.9% 감소) |
| 2022 | 8,793 | 6.32 → 2.79 (55.9% 감소) | 3.91 → 2.57 (34.3% 감소) |
| 2023 | 8,897 | 6.90 → 2.95 (57.3% 감소) | 3.99 → 2.44 (38.9% 감소) |
| 2024 | 10,234 | 7.12 → 3.44 (51.7% 감소) | 5.04 → 3.27 (35.2% 감소) |
| 2025 | 9,870 | 7.87 → 4.09 (48.0% 감소) | 6.51 → 4.30 (33.9% 감소) |
...
| 구장 | 주모형 X / Z | 원정 투수만 | 직구만 | 28일 구간 통제 |
| --- | --- | --- | --- | --- |
| 수원 | +15.5 / +6.1 | +15.7 / +6.0 | +17.1 / +7.0 | +15.7 / +6.0 |
| 문학 | -11.1 / +3.6 | -10.9 / +3.2 | -12.2 / +4.5 | -11.1 / +3.7 |
| 고척 | +5.1 / +8.7 | +5.5 / +8.8 | +5.8 / +9.9 | +5.4 / +8.7 |
| 사직 | -1.1 / -9.2 | -1.5 / -9.7 | -0.9 / -10.4 | -0.9 / -9.2 |
...
| 시즌 | 구장×시즌 (X / Z) | 구장×월 (X / Z) | 구장×시즌×구종 (X / Z) |
| --- | --- | --- | --- |
| 2020 | 4.01 / 2.82 | 3.87 / 2.83 | 3.94 / 2.79 |
| 2021 | 3.59 / 2.86 | 3.60 / 2.90 | 3.51 / 2.83 |
| 2022 | 2.79 / 2.57 | 2.82 / 2.61 | 2.68 / 2.53 |
| 2023 | 2.94 / 2.44 | 2.92 / 2.44 | 2.83 / 2.41 |
| 2024 | 3.44 / 3.27 | 3.32 / 3.15 | 3.35 / 3.24 |
| 2025 | 4.09 / 4.30 | 3.75 / 4.13 | 4.04 / 4.24 |
...
```text
manifest CSV SHA-256: 7d79a3c9ceedc64547cb2c9103aef60b801c52b86205a018b8549cbe06e0fa3b
pitch CSV SHA-256: 99c5b9ecda6f6156666a9a75affc9072027b276d8c36352070417339b6d97057
```
